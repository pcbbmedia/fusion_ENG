...
Market Share Distribution in Argentina (Pre-Acquisition)  <br><br>Flow (Telecom) and Movistar (Telefónica) are two of the main players in the market.  @cr-market-plot-highlighted
...
[@cr-mapa-post-fusion]{scale-by="7.8"} Market Reconfiguration After the Merger <br><br> After acquiring Movistar, Flow would become the <span style="color:#FFAC26">**MARKET LEADER**</span> in 17 provinces and achieve nationwide coverage. 
...
[@cr-barras-flow-post]{scale-by="0.9"} Post-Merger Market Share by Province: <br><br>• Río Negro (54.8%)<br><br>• CABA (53.9%)<br><br>• Neuquén (46.7%)<br><br>• San Juan (51.2%)
...
[@cr-nacional-share-post]{scale-by="0.9"} After the merger: <br><br> Flow would command 47.5% of the national market, becoming the undisputed leader. The next closest competitor, Claro, remains at 15.1%. 
